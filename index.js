...
IMPORTANT — AsIsRent fields (current, actual rent only): AsIsRent1-4 must reflect the rent actually being collected TODAY, not a hypothetical, estimated, market, or post-renovation figure. Listings routinely describe upside potential using phrases like "could rent for," "estimated rent," "market rent is," "each unit could fetch," or "approximate income based on" — these describe what the property MIGHT earn, not what it currently earns, and must NOT be used for AsIsRent unless the listing provides no current-rent figure at all. Use the actual current rent only when the listing says something like "currently rents for," "tenant pays," "rented at," or gives an explicit current lease amount. If the listing ONLY provides a hypothetical/potential rent with no stated current rent — especially alongside signals like "needs renovation," "sold as-is where-is," "priced below assessed value," or tenants who may not be paying market rate (family members, long-term or below-market tenants) — set AsIsRent to null rather than substituting the potential figure. Treating an aspirational number as today's actual income is a serious error: it makes a property that genuinely needs renovation and a rent increase look like it already performs at that level today.
